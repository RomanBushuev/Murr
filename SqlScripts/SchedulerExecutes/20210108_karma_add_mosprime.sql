...
values(3, 'DOWNLOAD MOSPRIME CBRF', 'Загрузка MosPrime');

insert into murr_downloader.default_saver_templates(task_type_id, default_path)
values(3, 'C:\Yandex\YandexDisk\Murr\Cbr\MosPrime');
...
-- FUNCTION: murr_downloader.add_cbr_foreign_exchange(timestamp without time zone)

-- DROP FUNCTION murr_downloader.add_cbr_foreign_exchange(timestamp without time zone);
